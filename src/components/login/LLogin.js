                ...
                <form name="contactform" className="contactform">
                    <div className="col-md-6">
                        <fieldset>
                            ...
                            <br/>
                            <input refs="name" type="text" size="30" placeholder="email" onChange={this.handleChange.bind(this, "email")} value={this.state.fields["email"]}/>
                            ...
                            <br/>
                            {/* <button onClick={this.contactSubmit.bind(this)}>nut bam</button> */}
                        </fieldset>
                    </div>
                </form>
            </div>
